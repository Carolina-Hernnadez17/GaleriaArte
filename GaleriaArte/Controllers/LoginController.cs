...
namespace GaleriaArte.Controllers
{
    public class LoginController : Controller
    {
        ...
        //        string query = "SELECT * FROM usuario WHERE correo = @correo AND contrasena = @contrasena AND estado = 1";
        ...
        //            if (reader.HasRows)
        //            {
        //                reader.Read(); // Leer la primera fila del resultado

        //                // Verificar el tipo de usuario desde la base de datos
        //                bool tipoUsuario = Convert.ToBoolean(reader["tipo_usuario"]);

        //                // Comparar si el tipo de usuario es 'false' (cliente) o 'true' (administrador)
        //                if (tipoUsuario == false)
        //                {
        //                    // Si es cliente (tipo_usuario = false), redirigir a la página de inicio
        //                    return RedirectToAction("Index", "Home");
        //                }
        //                else
        //                {
        //                    // Si es administrador (tipo_usuario = true), mostrar un mensaje
        //                    ViewBag.Error = "Acceso como administrador.";
        //                    return View();
        ...
        //                TempData["Mensaje"] = "¡Este es un mensaje flotante de información!";
        //                return View();
        //            }
        //        }
        //    }
        ...
        //        ViewBag.Error = "Error al realizar el login: " + ex.Message;
        //        return View();
        //    }
        //}
